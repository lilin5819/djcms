...
class Author(models.Model):
    ...
    profile = models.CharField('profile', default='',max_length=256)
    stat = models.CharField('stat',default='',max_length=256)
    password = models.CharField('password',default='123', max_length=256)
    register_date = models.DateTimeField(auto_now_add=True, editable=True)
    stat = models.CharField('stat',default='',max_length=256)
    task = models.TextField('task')
    taskprogress = models.IntegerField('taskprogress',default=0)
    taskcolor = models.CharField('taskcolor',default='default',max_length=256)
    #rateof_task = models.
...
class ArmInfo(models.Model):
    #time = models.DateField(auto_now_add=True)
    camera_state = models.BooleanField('camera_state',default=False)

    light = models.IntegerField('light_strength',default=0)
